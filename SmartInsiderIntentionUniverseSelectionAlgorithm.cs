...
namespace QuantConnect.Algorithm.CSharp
{
    public class SmartInsiderIntentionUniverseAlgorithm : QCAlgorithm
    {
        public override void Initialize()
        {
            ...
            var universe = AddUniverse<SmartInsiderIntentionUniverse>(data =>
            {
                foreach (SmartInsiderIntentionUniverse datum in data)
                {
                ...
                return from SmartInsiderIntentionUniverse d in data
